...
public class Plc1 {
	...
	@Async("taskExecutor")
	public void checkRecords() throws FileNotFoundException, IOException, ParseException, InterruptedException,
			ExecutionException, ModbusIOException, ModbusProtocolException, ModbusNumberException {
